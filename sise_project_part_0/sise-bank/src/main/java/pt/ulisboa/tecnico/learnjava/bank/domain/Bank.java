...
public class Bank {
	...
	public static void main(String[] args) throws BankException, AccountException, ClientException {
		// EXAMPLE CODE TO RUN THE BANK:
		/*
		 * Services services = new Services(); Bank cgd = new Bank("CGD");
		 * 
		 * Client clientOne = new Client(cgd, "José", "Manuel", "123456789",
		 * "987654321", "Street", 34); Client clientTwo = new Client(cgd, "José",
		 * "Manuel", "123456789", "987654321", "Street", 34);
		 * 
		 * cgd.createAccount(AccountType.CHECKING, clientOne, 100, 0); String iban =
		 ...
		 * 
		 * try { account.deposit(100); } catch (AccountException e) {
		 * System.out.println("You tried to deposit a negative amount of " +
		 * e.getValue()); }
		 * 
